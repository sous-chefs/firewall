class Chef
  class Resource::Firewall < Chef::Resource::LWRPBase
    ...
    # for Windows firewall implementations, do you want to keep default firewall rules?
    attribute(:windows_default_rules, kind_of: [TrueClass, FalseClass], default: false)
  end
end
