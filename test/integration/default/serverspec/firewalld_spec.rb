...
expected_rules = [
  ...
  %r{ipv4 filter INPUT 50 -p tcp -m tcp -m multiport --dports 777 -m comment --comment compile -j ACCEPT},
  ...
  %r{ipv6 filter INPUT 50 -p tcp -m tcp -m multiport --dports 777 -m comment --comment compile -j ACCEPT},
